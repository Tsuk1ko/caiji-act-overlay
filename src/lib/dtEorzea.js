...
export function outTime(rDate) {
  return [paddingLeft(rDate.getHours(), 2), paddingLeft(rDate.getMinutes(), 2)].join(':');
}

export function outTimeSec(rDate) {
  return [paddingLeft(rDate.getHours(), 2), paddingLeft(rDate.getMinutes(), 2), paddingLeft(rDate.getSeconds(), 2)].join(':');
}
...
function getTimeByDate(timeText, dtEorzea) {
